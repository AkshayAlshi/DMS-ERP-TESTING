...
import com.PomForAccountsVoucher.BankPaymentPom;

import TestBase.TBase;
import Utilitys.XLUtils1;

public class BankPaymentTest  extends TBase{
	 ...
	 XLUtils1 reader = new XLUtils1();
	    ...
	    String sheetName ="BankPaymentTest";
	    int rowCount;
	    int colCount;

	    public BankPaymentTest() throws IOException {
	        super();
	    ...
	    public void setup() throws Exception {
	        ...
	        initialization();
	        Thread.sleep(2000);
	        selectModuleNameForAdminWithForm(prop.getProperty("ModlueXpath-BankPaymentTest"), prop.getProperty("SubModuleXapath-BankPaymentTest"), prop.getProperty("FormSelection-BankPaymentTest"));
	    }
...
//	                String CostCenter = reader.getCellData(sheetPath, sheetName, rowNum, colNum+3);
	                ...
	                BankPaymentPom BP = new BankPaymentPom(driver);
